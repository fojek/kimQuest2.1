...
public:
    ...
    void setupUi(QMainWindow *kimQuest2Class)
    {
        ...
        contenu->setGeometry(QRect(10, 40, 501, 221));
        QPalette palette1;
        ...
        contenu->setStyleSheet(QStringLiteral("background-image: url(:/kimQuest2/parchemin.jpg);"));
        ...
        imageLabel->setGeometry(QRect(520, 10, 431, 371));
        ...
        choix1->setGeometry(QRect(10, 270, 501, 23));
        ...
        choix2->setGeometry(QRect(10, 300, 501, 23));
        ...
        choix3->setGeometry(QRect(10, 330, 501, 23));
        ...
        choix4->setGeometry(QRect(10, 360, 501, 23));
        ...
        titre->setGeometry(QRect(10, 10, 501, 31));
        QPalette palette2;
        ...
        objectif1->setGeometry(QRect(1010, 170, 131, 20));
...
"gridline-color: rgb(0, 255, 127);"));
        ...
        objectif2->setGeometry(QRect(1010, 190, 131, 20));
        objectif3 = new QCheckBox(centralWidget);
        objectif3->setObjectName(QStringLiteral("objectif3"));
        objectif3->setGeometry(QRect(1010, 210, 131, 20));
